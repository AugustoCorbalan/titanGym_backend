...
import getLatestNotificationsAllsUser from "./controllers/notificationsControllers/getLatestNotificationsAllsUsers.js";
...
router.get('/getLatestNotificationsAllsUsers', verifyToken, (req, res)=> getLatestNotificationsAllsUser(req, res));
