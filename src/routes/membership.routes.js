...
import getMembershipsUser from './controllers/membershipControllers/getMembershipsUser.js';
...
router.get('/getMembershipsUser', verifyToken, (req, res)=> getMembershipsUser(req, res));
